...
def get_args():
    ...
    p.add_argument("--video", type=str, default='D:/Data1/b75c865f92e540ba96b3fc4652499a.mp4', help="Input video path")
    p.add_argument(
        "--output",
        type=str,
        default=None,
    ...
    p.add_argument(
        "--checkpoint",
        type=str,
        default='checkpoints/Soccernetball/SoccerNetBall-1/checkpoint_epoch_0007.pt',
